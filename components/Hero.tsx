  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Badge */}
        <div className="inline-flex items-center px-3 py-1 rounded-full border border-bgtech-blue/30 bg-bgtech-blue/10 backdrop-blur-sm mb-8 animate-fade-in-up">
          <span className="w-2 h-2 rounded-full bg-bgtech-blue animate-pulse mr-2"></span>
          <span className="text-bgtech-blue text-xs font-display font-bold tracking-widest uppercase">
            Next-Gen Digital Solutions
          </span>
        </div>

        {/* Headline */}
        <h1 className="text-4xl md:text-6xl lg:text-8xl font-display font-bold leading-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-200 to-gray-500 tracking-tighter">
          Tenha um site igual a esse <br />
          <span className="relative">
            É uma <span className="text-white text-glow">Máquina de Vendas</span>.
            {/* Underline decoration */}
            <svg className="absolute w-full h-3 -bottom-2 left-0 text-bgtech-red opacity-80" viewBox="0 0 100 10" preserveAspectRatio="none">
        ...
        {/* Subheadline */}
        <p className="mt-6 max-w-2xl mx-auto text-lg md:text-xl text-gray-400 leading-relaxed mb-12">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="glass-panel p-1 rounded-2xl bg-gradient-to-b from-gray-800/50 to-black/50 border border-white/10 backdrop-blur-xl">
             <div className="bg-bgtech-dark/80 rounded-xl p-6 md:p-8 transition-all duration-500">
                
                {!selection ? (
                  <div className="animate-fade-in-up">
                    <h3 className="text-xl text-white font-display font-bold mb-6 flex items-center justify-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <button 
                        ...
                        className="group relative p-6 rounded-xl border border-white/5 hover:border-bgtech-blue/50 bg-gray-900/50 hover:bg-bgtech-blue/10 transition-all duration-300 text-left flex flex-col items-center md:items-start"
                      >
                        <div className="p-3 rounded-lg bg-bgtech-blue/20 text-bgtech-blue mb-4 group-hover:scale-110 transition-transform">
                          <Monitor className="w-6 h-6" />
                        </div>
                        <h4 className="text-lg font-bold text-white mb-1">Site & Software</h4>
                        <p className="text-sm text-gray-400">Preciso de um site rápido, aplicativo ou sistema.</p>
                      ...
                      <button 
                        ...
                        className="group relative p-6 rounded-xl border border-white/5 hover:border-bgtech-red/50 bg-gray-900/50 hover:bg-bgtech-red/10 transition-all duration-300 text-left flex flex-col items-center md:items-start"
                      >
                        <div className="p-3 rounded-lg bg-bgtech-red/20 text-bgtech-red mb-4 group-hover:scale-110 transition-transform">
                          <Globe className="w-6 h-6" />
                        </div>
                        <h4 className="text-lg font-bold text-white mb-1">Agenciamento Digital</h4>
                        <p className="text-sm text-gray-400">Quero melhorar minha presença e vendas online.</p>
                  ...
                  <div className="animate-fade-in-up flex flex-col items-center">
                    <div className="mb-6 text-center">
                      ...
                      <div className="flex items-center justify-center space-x-2 text-xl font-bold text-white">
                    ...
                    <button 
                      ...
                      className={`group relative px-8 py-4 w-full md:w-auto overflow-hidden rounded-sm ${selection === 'site' ? 'bg-bgtech-blue' : 'bg-bgtech-red'}`}
                    >
                      <div className="absolute inset-0 w-0 bg-white transition-all duration-[250ms] ease-out group-hover:w-full opacity-10"></div>
                      <span className="relative flex items-center justify-center text-white font-display font-bold tracking-wider uppercase text-lg">
                    ...
                    <button 
                      ...
                      className="mt-4 text-sm text-gray-500 hover:text-white flex items-center transition-colors"
                    >
          ...
          <div className="mt-8 flex justify-center">
             <button onClick={() => document.getElementById('showcase')?.scrollIntoView({behavior: 'smooth'})} className="text-gray-500 hover:text-bgtech-blue transition-colors flex items-center text-sm font-medium uppercase tracking-widest group">
                Ver Portfólio
